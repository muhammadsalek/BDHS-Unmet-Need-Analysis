...
[![DOI](https://img.shields.io/badge/DOI-10.1186%2Fs12905--026--04788--2-blue)](https://doi.org/10.1186/s12905-026-04788-2)
[![Journal](https://img.shields.io/badge/Journal-BMC%20Women's%20Health-black)](https://doi.org/10.1186/s12905-026-04788-2)
...
Unmet need for family planning remains a persistent public health challenge in low- and middle-income countries and a core indicator for **SDG 3 (Universal Health Coverage)**. This study is among the first to examine the association between internet use and unmet need for family planning specifically among currently pregnant women in Bangladesh, integrating nationally representative survey data with divisional spatial mapping to identify where the burden concentrates.

This repository serves as a complete, transparent research compendium — including analysis code, derived data, publication figures and tables, and the full peer-review and revision trail — in accordance with open-science and reproducibility norms (STROBE-compliant reporting).
...
Email: saleksta@gmail.com · [ORCID: 0009-0005-5973-461X](https://orcid.org/0009-0005-5973-461X) · [Google Scholar](https://scholar.google.co.uk/scholar?as_sauthors=%22Md%20Salek%20Miah%22)

**Md Jamal Uddin, Ph.D.** *(Corresponding Author)*
Professor, Department of Statistics, SUST, Sylhet-3114, Bangladesh; Faculty of Graduate Education, Daffodil International University, Dhaka
Email: jamal-sta@sust.edu · Tel: +8801716972846 · [ORCID: 0000-0002-8360-3274](https://orcid.org/0000-0002-8360-3274) · [Google Scholar](https://scholar.google.com/citations?user=tMZWkOUAAAAJ)
...
| Study population | Currently pregnant women, 15–49 years |
| Sample size | n = 4,370 |
| Survey design | BDHS 2022 complex survey design, with sampling weights |
...
| Spatial scope | 8 administrative divisions of Bangladesh |
...
| Peer review | Two rounds, five independent reviewers; full trail archived in this repository |
...
flowchart TD
    ...
    E --> F
    F --> G[Two Rounds of Peer Review - 5 Reviewers]
...
| Prevalence of unmet need for family planning | 41% |
| Internet use → unmet need (adjusted) | aOR = 1.83 (95% CI: 1.52–2.20) |
| Early age at first birth (10–17 years) | aOR = 2.70 (95% CI: 1.91–3.82) |
...
**Figure 1.** Participant selection and analytical workflow from BDHS 2022. The flowchart illustrates the step-by-step process from initial sample selection (n = 30,129) to the final analytical cohort (n = 4,370 currently pregnant women aged 15–49 years).
...
| Round 1 review (Reviewers 1–2) and author response | — |
| Round 2 review (Reviewers 3–5) and author response | — |
...
|---|---|---|
| BDHS 2022 | [DHS Program](https://dhsprogram.com) | Bangladesh Demographic and Health Survey 2022 |
| Division shapefile | Bangladesh administrative boundaries | 8 divisions — spatial polygons |
| `descriptive_data.dta` | Cleaned analytic sample | Currently pregnant women, 15–49 years, weighted |
...
- **Stata** (≥ 15) — descriptive and regression analysis
- **R** (≥ 4.2) — spatial analysis and mapping (`sf`, `spdep`, `spatialreg`, `tmap`, `ggplot2`, `tidyverse`, `viridis`, `patchwork`)
- **LaTeX** — methodology flowchart
...
- **Spatial epidemiology** — geographic disparities in unmet need across 8 divisions
- **Public health** — evidence for SDG 3 (Universal Health Coverage) monitoring
- **Health policy** — subgroup-level insight for targeted family planning interventions
- **Open science** — full compendium of code, data, figures, tables, and peer-review trail

---

## License

Code is released under the **MIT License** — Copyright © 2026 Md Salek Miah and Md Jamal Uddin.

Article content is licensed **CC BY-NC-ND 4.0** by the authors under *BMC Women's Health* / Springer Nature. Citation is required for any reuse.
...
Email: saleksta@gmail.com · GitHub: [muhammadsalek](https://github.com/muhammadsalek)
